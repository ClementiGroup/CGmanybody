...
U2_break = np.loadtxt('U2_break.txt')
...
for i in range(N):
	...
	U2[x,y,:] = U2[x,y,:] + U2_break[i,:] # compute sum of U for each bin
...
def plot_avgU(H,title,level):
	...
	ax = fig.gca()
	surf = plt.imshow(H, cmap = cm.jet, interpolation='nearest', origin='low',extent=[-35, 5, -20, 20])
...
plot_avgU(U2[:,:,0],'Avg_U2_1',30)
plot_avgU(U2[:,:,1],'Avg_U2_2',30)
plot_avgU(U2[:,:,2],'Avg_U2_3',30)
plot_avgU(U2[:,:,3],'Avg_U2_4',30)
plot_avgU(U2[:,:,4],'Avg_U2_5',30)

# plot_avgU(U234[:,:,0],'Avg_U234_1',6)
# plot_avgU(U234[:,:,1],'Avg_U234_2',6)
# plot_avgU(U234[:,:,2],'Avg_U234_3',6)
# plot_avgU(U234[:,:,3],'Avg_U234_4',6)
# plot_avgU(U234[:,:,4],'Avg_U234_5',6)
