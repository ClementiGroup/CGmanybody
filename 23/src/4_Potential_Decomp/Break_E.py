...
model3BD1 = torch.load('../1_CV/Mymodel3BD1.pt')
model3BD2 = torch.load('../1_CV/Mymodel3BD2.pt')
model3BD3 = torch.load('../1_CV/Mymodel3BD3.pt')
model3BD4 = torch.load('../1_CV/Mymodel3BD4.pt')
model3BD5 = torch.load('../1_CV/Mymodel3BD5.pt')


U2_break = np.zeros((N,5)) # 0,1,2 are total, pri and net
...
for i in range(n):
	...
	U_2BD = model2BD(Features).detach()
	# U_3BD = model3BD(Features).detach()
	...
	U_2BD1 = model2BD1(F_dist,F_cos,F_sin,F_angle).detach()
	U_2BD2 = model2BD2(F_dist,F_cos,F_sin,F_angle).detach()
	U_2BD3 = model2BD3(F_dist,F_cos,F_sin,F_angle).detach()
	U_2BD4 = model2BD4(F_dist,F_cos,F_sin,F_angle).detach()
	U_2BD5 = model2BD5(F_dist,F_cos,F_sin,F_angle).detach()


	print(U_3BD1.shape)

	# U_break[i*N1:(i+1)*N1,:] = np.concatenate((U_2BD,U_3BD,U_4BD,U_4BDchiral,U23,Total1,Total2),axis=1)
	U2_break[i*N1:(i+1)*N1,:] = np.concatenate((U_2BD1,U_2BD2,U_2BD3,U_2BD4,U_2BD5),axis=1)
	U23_break[i*N1:(i+1)*N1,:] = np.concatenate((U_3BD1,U_3BD2,U_3BD3,U_3BD4,U_3BD5),axis=1)+U_2BD
...
print(U3_break.shape)
np.savetxt('U3_break.txt', U3_break)
np.savetxt('U23_break.txt', U23_break)
...
U3_break = U3_break - np.min(U3_break,axis=0)
U23_break = U23_break - np.min(U23_break,axis=0)
...
plot_U(U3_break[:,0],'U3BD_1',4)
plot_U(U3_break[:,1],'U3BD_2',4)
plot_U(U3_break[:,2],'U3BD_3',4)
plot_U(U3_break[:,3],'U3BD_4',4)
plot_U(U3_break[:,4],'U3BD_5',4)

plot_U(U23_break[:,0],'U23BD_1',30)
plot_U(U23_break[:,1],'U23BD_2',30)
plot_U(U23_break[:,2],'U23BD_3',30)
plot_U(U23_break[:,3],'U23BD_4',30)
plot_U(U23_break[:,4],'U23BD_5',30)
