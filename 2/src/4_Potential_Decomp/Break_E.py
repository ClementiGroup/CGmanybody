...
# model2BD = torch.load('../1_CV/Mymodel2BD1.pt')
...
model2BD1 = torch.load('../1_CV/Mymodel2BD1.pt')
model2BD2 = torch.load('../1_CV/Mymodel2BD2.pt')
model2BD3 = torch.load('../1_CV/Mymodel2BD3.pt')
model2BD4 = torch.load('../1_CV/Mymodel2BD4.pt')
model2BD5 = torch.load('../1_CV/Mymodel2BD5.pt')
...
print(U2_break.shape)
np.savetxt('U2_break.txt', U2_break)
...
U2_break = U2_break - np.min(U2_break,axis=0)
...
plot_U(U2_break[:,0],'U2BD_1',7)
plot_U(U2_break[:,1],'U2BD_2',7)
plot_U(U2_break[:,2],'U2BD_3',7)
plot_U(U2_break[:,3],'U2BD_4',7)
plot_U(U2_break[:,4],'U2BD_5',7)

# plot_U(U234_break[:,0],'U234BD_1',7)
# plot_U(U234_break[:,1],'U234BD_2',7)
# plot_U(U234_break[:,2],'U234BD_3',7)
# plot_U(U234_break[:,3],'U234BD_4',7)
# plot_U(U234_break[:,4],'U234BD_5',7)
